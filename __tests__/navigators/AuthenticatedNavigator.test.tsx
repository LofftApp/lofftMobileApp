...
//     expect(screen.getByTestId('NewUserStack').props.userType).toBe('newuser');
//     expect(screen.getByTestId('NewUserStack').props.admin).toBe(false);
//   });
//   //   expect(screen.getByTestId('newuser-admin:false').props.userType).toBe(
//   //     'newuser',
//   //   );
//   //   expect(screen.getByTestId('newuser-admin:false').props.admin).toBe(false);
//   // });
