...
const FlatInfoContainer = ({
  ...
  const renterObject = {
    header:
      "You've applied dfor this Lofft. The owner has a maximum of 48 hours to get back to you!",
    description1: '⚡️ Remaining tokens: 5 ',
    button1: 'See all applications',
    button2: 'Back to search',
  };
